  ...
  var Lt = {
      ...
      effect: function (t) {
        ...
        null != r &&
          ...
          ((e.elements.arrow = r),
          (e.modifiersData[i + "#persistent"] = { padding: kt("number" != typeof a ? a : At(a, ot)) }));
      },
      ...
      return (
        ...
        (r.setElementContent = function (t, e) {
          if (null !== t)
            return "object" == typeof e && d(e)
              ...
              : void (this.config.html
                  ? (this.config.sanitize && (e = ke(e, this.config.allowList, this.config.sanitizeFn)),
                    (t.innerHTML = e))
                  : (t.textContent = e));
        }),
        (r.getTitle = function () {
        ...
        (r._getPopperConfig = function (t) {
          ...
          return n(
            {},
            i,
            "function" == typeof this.config.popperConfig ? this.config.popperConfig(i) : this.config.popperConfig
          );
        }),
